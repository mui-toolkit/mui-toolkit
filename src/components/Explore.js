		...
		<React.Fragment>
			...
			<Grid direction="column" alignItems="center" className={classes.container}>
				<Paper style={{ padding: '1em' }}>
					...
					{selectedIndex === 0 && (
						<ExploreTable themesToMap={exploreThemes.reverse()} signedInUserId={signedInUserId} />
					)}
					{selectedIndex === 1 && (
						<ExploreTable
							themesToMap={exploreThemes.sort((a, b) => b.trending - a.trending)}
							signedInUserId={signedInUserId}
						/>
					)}
					{selectedIndex === 2 && (
						<ExploreTable
							themesToMap={exploreThemes.sort((a, b) => b.bookmarksCount - a.bookmarksCount)}
							signedInUserId={signedInUserId}
						/>
					)}
					{selectedIndex === 3 && (
					...
					{selectedIndex === 4 && (
						<ExploreTable
							themesToMap={exploreThemes.sort((a, b) => b.starsCount - a.starsCount)}
							signedInUserId={signedInUserId}
						/>
					)}
				</Paper>
