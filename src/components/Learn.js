        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            >
              ...
              <Link href="https://material-ui.com/styles/api/#themeprovider">
                ThemeProvider
              </Link>{" "}
              ...
              wraps all the other components you want styled. This feature
              allows for less in-line styling, and allows for consistent styling
              throughout your application. Check out Material-Ui's documentation
              to learn more about{" "}
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            <Typography
              ...
              gutterBottom
            >
              mymui provides two tools for styling and building Material-UI
              components quickly and easily. <br />
              <br />
              The first is the{" "}
              <Link href="/design">
                <b>Theme Styler</b>
              </Link>
              , which allows you to customize your Material-UI theme without
              having to frequently refer to documentation. The dynamic interface
              provides a step by step guide on the parameters you can manipulate
              within the ThemeProvider. Once finished, you can download the json
              file and copy and paste the code into your own project.
              <br />
              <br />
              ...
              . This tool follows the 12 column grid system, and is meant to
              help users visualize how Material-UI structures{" "}
              <Link href="https://material-ui.com/components/grid">
                grid layouts
              </Link>{" "}
              and positioning.
            </Typography>
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            >
              ...
              . It also helps you understand how to position and align your
              items to achieve your desired layout.
            </Typography>
          </Grid>
          <Grid item align="center" className={classes.title} xs={6}>
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            >
              ...
              allows you to style your ThemeProvider component with a dynamic
              and visual interface. No need to look at the documentation — just
              select the colors and styles you want and download your theme!
            </Typography>
          </Grid>
          <Grid item align="center" className={classes.title} xs={6}>
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            >
              ...
              createMuiTheme function. This will generate a theme based on the
              custom object you provide!
              <br />
              <br />
              Visit the{" "}
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            >
              ...
              ! The explore page allows you to view, star, and bookmark themes
              created by other users, and share your custom themes with the
              mymui community.
            </Typography>
          </Grid>
          <Grid item align="center" className={classes.title} xs={6}>
        ...
        >
          <Grid item className={classes.title} xs={6}>
            ...
            <Typography
              ...
              gutterBottom
            >
              mymui was conceptualized and built by Manny Garcia, Nelson Liu,
              Rana Quadri, and Alexander Wang. <br /> <br />
              Created with React, Firebase, Firestore, Material-UI, FileSaver,
              and thum.io.
            </Typography>
