					...
					<Grid container align="center" spacing={2}>
						<Grid item xs={6}>
							...
							<Links component={Link} to="/design" onClick={handleClose}>
								<img alt="theming tool" src={themingTool} style={{ width: '100%' }} />
							</Links>

							<Typography gutterBottom style={{ marginTop: '1em', color: '#818181' }}>
								Style your Material-UI Theme Provider component with our Theme Styler.
							</Typography>
						</Grid>
						<Grid item xs={6}>
							<Button
